...
description: 'My colleague has just checked in the code that they have been writing all week. We were working on a graphics editor canvas, and they implemented the ability to resize shapes like rectangles and ovals by dragging small handles at their edges.',
author: {
name: 'Dan Abramov',
...
author: 'Photo by Oliver Hale on Unsplash',
},
};
