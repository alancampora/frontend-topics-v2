    ...
    <footer>
      <div className=" bg-indigo-900">
        <div className="flex justify-center">
          <SvgIcon
            href="https://twitter.com/alancampora"
          ...
          />
          <SvgIcon
            href="https://github.com/alancampora"
        ...
        <div className="text-center text-purple-300">
          <a
            className="mx-auto"
            href="https://www.patreon.com/bePatron?u=7457506"
          >
            Become a Patron!
          </a>
        </div>
        ...
        <div className="text-center">
          <p className="text-purple-300">
            Made with a lot of love by Alan Campora
          </p>
        </div>
      </div>
    </footer>
